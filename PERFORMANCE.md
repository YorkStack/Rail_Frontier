...
Build is static and fonts are bundled locally. The TECH-001 production build reports app JavaScript 250.22 KB / 75.09 KB gzip, Three.js 640.71 KB / 160.48 KB gzip and CSS 23.28 KB / 6.10 KB gzip. The Norway campaign pack is loaded separately and contains 64 GLBs plus 12 PNGs (1.19 MiB downloaded; about 7.0 MiB decoded texture allocation including mipmaps). The 500 KB Three.js chunk advisory remains visible and is acceptable for this engine dependency; the complete initial payload is well below the 5 MB goal. Add menu/lazy campaign loading when content grows, not a warning suppression.
