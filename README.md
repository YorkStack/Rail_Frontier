...
Runtime checkpoint `ee098f4` passes 138 Node tests, focused Norway V3 and Arizona V2 landform/material/architecture browser checks, construction, V1↔V3 replacement and full passenger/mail/save browser journeys, TypeScript, both asset-pack validations and the test build. Arizona has dedicated geology, entry, street and house-close review cameras; its entry view records 116 calls and 1,110,250 main-pass triangles without shader or WebGL context errors. The following screenshots will be replaced after the integrated GFX-R08/09 visual gate.
