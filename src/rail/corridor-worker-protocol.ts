...
export interface CorridorWorkerRequest {type:'plan-corridors';wishPath?:boolean;identity:CorridorPlanningIdentity;anchors:Vec3[];tangents:AlignmentTangents;terrain:TerrainWindowSnapshot;candidateBudget:number;maxOffsetM:number;expansionBudget:number}
