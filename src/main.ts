...
app.innerHTML=`
  ...
  <section id="main-menu" class="main-menu" aria-label="Main menu">
    <div class="menu-sidebar">
      ...
      <p class="menu-version">EARLY OPERATIONS · BUILD 0.3</p>
    </div>
