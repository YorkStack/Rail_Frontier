...
export const emptyOperations=(towns:readonly Pick<Town,'id'|'population'>[]=[]):OperationsState=>({demand:[],trainServices:{},reservations:[],infrastructure:{},industryCycleTicks:{},townEconomy:initialTownEconomy(towns),delivered:{passengers:0,timber:0,lumber:0},completedObjectives:[],monthlyAccounts:[],lastCommandSequence:0});
