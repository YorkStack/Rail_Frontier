...
const validate=(definition:WorldDefinition,profile:typeof norwayV1WorldProfile|typeof norwayV2WorldProfile)=>{
...
const generators:ReadonlyMap<number,WorldGenerator>=new Map([[1,norwayV1WorldGenerator],[2,norwayV2WorldGenerator]]);
