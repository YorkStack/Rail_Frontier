...
const validate=(definition:WorldDefinition,profile:typeof norwayV2WorldProfile|typeof norwayV3WorldProfile)=>{
...
const generators:ReadonlyMap<number,WorldGenerator>=new Map([[2,norwayV2WorldGenerator],[3,norwayV3WorldGenerator]]);
