...
The user switched to Sol and resumed implementation. GFX-001 through GFX-004 are complete: [baseline](docs/art/GFX001_BASELINE.md), [session replacement](docs/art/GFX002_SESSION_COMPATIBILITY.md), [V2 landforms](docs/art/GFX003_V2_LANDFORMS.md) and [surface materials/daylight](docs/art/GFX004_SURFACES.md). New companies use the two-bank V2 fjord and inland valley; V1 saves retain their exact terrain and load across versions on the shared context. V2 has subdued summer snow, two-axis slope masks and original tileable colour/normal/roughness terrain maps. Proceed with GFX-005 rocks/vegetation, then continue through GFX-008 including GFX-006B. Do not automatically resume mail work.
