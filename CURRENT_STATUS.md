...
Read the three active plans and IMPLEMENTATION_PLAN.md first. Continue with CON-04: make cuts, fills, retaining structures, bridge transitions and tunnel portals semantic consequences of the certified station-first alignment while preserving atomic purchase and older saves.
...
Next: implement CON-04 semantic terrain operations, then CON-05/06 construction completion and interaction polish. Commit and push each completed checkpoint to both branches and verify their remote hashes. Great River and advanced signaling remain later systems.
