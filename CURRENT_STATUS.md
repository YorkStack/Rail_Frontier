...
The user switched to Sol and resumed implementation. GFX-001 through GFX-006B are complete: [baseline](docs/art/GFX001_BASELINE.md), [session replacement](docs/art/GFX002_SESSION_COMPATIBILITY.md), [V2 landforms](docs/art/GFX003_V2_LANDFORMS.md), [surface materials/daylight](docs/art/GFX004_SURFACES.md), [Blender scenery](docs/art/GFX005_SCENERY.md), [settlements](docs/art/GFX006_SETTLEMENTS.md) and [rolling stock](docs/art/GFX006B_ROLLING_STOCK.md). V1 saves retain their exact terrain. V2 now has two fjord banks, original PBR surfaces, mixed clustered forest/rocks, three deterministic villages with eight timber finishes plus dedicated industry buildings, and detailed current steam/passenger/freight vehicles. Proceed with GFX-007/GFX-008. Do not automatically resume mail work.
