...
The user switched to Sol and resumed implementation. GFX-001 through GFX-003 are complete: [baseline](docs/art/GFX001_BASELINE.md), [session replacement](docs/art/GFX002_SESSION_COMPATIBILITY.md) and [V2 landforms](docs/art/GFX003_V2_LANDFORMS.md). New companies use the two-bank V2 fjord and inland valley; V1 saves retain their exact terrain and load across versions on the shared context. Proceed with GFX-004 surface materials/daylight, then continue through GFX-008 including GFX-006B. Do not automatically resume mail work.
