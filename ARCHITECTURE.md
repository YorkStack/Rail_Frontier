...
| persistence/save, indexeddb | Schema 8, sequential migrations, semantic validation and durable slots | Implemented with station-layout and semantic-terrain migrations, autosave and archive UI |
