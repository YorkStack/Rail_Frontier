...
**Active extension, 2026-09-15:** See [station-first construction architecture](docs/construction/STATION_TRACK_DESIGN.md). CON-01 has landed with standalone station layouts, level platform track, stable ports and schema 7. CON-02 has a browser-proven two-station connection flow and is being expanded with editable waypoints and a multi-section transaction.
