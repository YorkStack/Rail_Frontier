...
**Active extension, 2026-09-15:** See [station-first construction architecture](docs/construction/STATION_TRACK_DESIGN.md). CON-01/02 have landed with standalone station layouts, level platform track, stable ports, schema 7, live multi-waypoint splines and one atomic multi-section construction command. CON-03 vertical profiles and track classes are next.
