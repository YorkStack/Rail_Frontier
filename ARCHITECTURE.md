...
**Active extension, 2026-09-15:** See [station-first construction architecture](docs/construction/STATION_TRACK_DESIGN.md). CON-01–03 have landed with standalone station layouts, level platform track, stable ports, schema 7, live multi-waypoint horizontal/vertical splines, three track standards, advance braking and one atomic multi-section construction command. GFX-R03 natural terrain materials are next.
