...
| Instancing | Supported | 20k trees, 2k buildings, 99 additional train proxies; 38 total stress draw calls |
...
| Shadows / haze / color pipeline | Supported | PCF soft sun shadows, FogExp2, ACES tone mapping, sRGB output |
| Asset normals / materials | Supported | Finite imported normal buffers, three materials; close camera visual inspected |
...
| Frustum culling / spatial | Partially validated | Instanced bounds/culling working; spatial chunking remains scale optimization |
