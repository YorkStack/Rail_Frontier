...
| GFX-008: complete regression and handback — **complete** ([evidence](GFX008_REGRESSION.md)) | Unit/asset/build checks, original passenger/freight/finance/city/archive flows, V1/V2 saves, mobile/desktop screenshots, repeated scene replacement/disposal, documentation. | All functional and visual gates below pass. Record actual counts and metrics. Only then resume the mail-transport backlog. |
