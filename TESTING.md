...
Current Norway passenger/freight milestone: **71 Node tests**, **7 browser integration/end-to-end tests**, strict TypeScript, Blender GLB structural validation and production build. Browser screenshot/trace/temp outputs are ignored under artifacts/. Compact reference benchmark JSON is copied to docs/evidence/ for review.
...
QA-001 and ECON-003 are complete. The automatic commissioned preview remains the attractive landing state, while selecting “Start new company” creates the empty railway and empty-industry state used by the player-action gate.
