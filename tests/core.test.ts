...
test('save loader rejects future schemas, malformed data and dangling references',()=>{
  const json=serialize(fixture());assert.throws(()=>deserialize(json.replace('"schemaVersion":4','"schemaVersion":99')));
